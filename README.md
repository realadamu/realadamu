...
💻 My core interests are distributed architecture, software design, and back-end performance optimisation. I'm proficient in **Go/Java concurrency** (Threads, GMP model, Go/Java performance optimisation), **Cloud Native** (Docker, Podman, Kubernetes, Istio), and **back-end frameworks and middleware** (Spring Boot, Spring Cloud, gRPC, Etcd, Kafka, Redis, MySQL). I’ve also independently designed microservice frameworks and built scalable automation platforms used by thousands of servers.
